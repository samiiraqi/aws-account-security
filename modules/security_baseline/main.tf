...
# ---------------------------------------------------------------
# 3. CloudTrail — Encrypted with KMS
# ---------------------------------------------------------------
    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "aws:SourceArn" = "arn:aws:cloudtrail:${var.aws_region}:${var.aws_account_id}:trail/${var.cloudtrail_name}"
          }
        }
      },
      {
...
# ---------------------------------------------------------------
# 4. SSM — Block Public Document Sharing
# ---------------------------------------------------------------
